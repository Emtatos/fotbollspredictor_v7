...
ALL_FEATURE_COLUMNS = BASE_FEATURE_COLUMNS + STATS_FEATURE_COLUMNS + ODDS_FEATURE_COLUMNS

ABLATION_GROUPS = {
    "base": BASE_FEATURE_COLUMNS,
    "+stats": BASE_FEATURE_COLUMNS + STATS_FEATURE_COLUMNS,
    "+odds": BASE_FEATURE_COLUMNS + STATS_FEATURE_COLUMNS + ODDS_FEATURE_COLUMNS,
}
